    ...
    <body>
        ...
        String status=o.auth(o);
                        ...
                        if(status.equals("done"))
                        {
                         ...
                         out.println("<tr><td><a href=view.jsp?view=true&sub=Submit&test="+(String)o.getTest()+"><h2>Check Errors</h2></a></td></tr>");
                        }
                        ...
                        out.println("<tr><td><a href=TEST.jsp?ques=1&sub=Submit&test="+(String)o.getTest()+">Start Test</a></td></tr>");
